...
@ConditionalOnProperty(
    prefix = "custom",
    name = "provide-test-todo-controller",
    havingValue = "true")
public class TodoTestCollaborationService {
  ...
  private static final Logger LOG =
      LoggerFactory.getLogger(TodoTestCollaborationService.class.getName());
  ...
  public String testConfirmCollaboration() {
    ...
    String message = "User " + name + " has accepted your collaboration request for todo #1.";
